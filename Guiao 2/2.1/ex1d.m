...
prob2M = sum(sum(lancamentos)>=k2)/N; %probabilidade do segundo filho ser rapaz (M >= 2) (casosfav/Nexp)
prob1M= sum(sum(lancamentos)==k)/N; %Sabendo que o primeiro filho de uma famılia com 2 filhos é rapaz (M==1) (casosfav/Nexp)
